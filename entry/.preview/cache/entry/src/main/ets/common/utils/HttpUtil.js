...
export function httpRequestGet(url) {
    ...
    return responseResult.then((value) => {
        if (value.responseCode === Const.HTTP_CODE_200) {
            ...
            serverData.msg = `${{ "id": 16777233, "type": 10003, params: [], "bundleName": "com.example.newsdataarkts", "moduleName": "entry" }}&${value.responseCode}`;
        }
        return serverData;
    }).catch(() => {
        serverData.msg = { "id": 16777233, "type": 10003, params: [], "bundleName": "com.example.newsdataarkts", "moduleName": "entry" };
        return serverData;
    });
}
