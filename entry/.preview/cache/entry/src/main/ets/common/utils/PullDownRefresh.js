...
export function pullRefreshState(newsModel, state) {
    switch (state) {
        case 0 /* DropDown */:
            newsModel.pullDownRefreshText = { "id": 16777237, "type": 10003, params: [], "bundleName": "com.example.newsdataarkts", "moduleName": "entry" };
            newsModel.pullDownRefreshImage = { "id": 16777229, "type": 20000, params: [], "bundleName": "com.example.newsdataarkts", "moduleName": "entry" };
            newsModel.isCanRefresh = false;
            newsModel.isRefreshing = false;
            newsModel.isVisiblePullDown = true;
            break;
        case 1 /* Release */:
            newsModel.pullDownRefreshText = { "id": 16777242, "type": 10003, params: [], "bundleName": "com.example.newsdataarkts", "moduleName": "entry" };
            newsModel.pullDownRefreshImage = { "id": 16777219, "type": 20000, params: [], "bundleName": "com.example.newsdataarkts", "moduleName": "entry" };
            newsModel.isCanRefresh = true;
            newsModel.isRefreshing = false;
            break;
        case 2 /* Refreshing */:
            newsModel.offsetY = vp2px(newsModel.pullDownRefreshHeight);
            newsModel.pullDownRefreshText = { "id": 16777241, "type": 10003, params: [], "bundleName": "com.example.newsdataarkts", "moduleName": "entry" };
            newsModel.pullDownRefreshImage = { "id": 16777251, "type": 20000, params: [], "bundleName": "com.example.newsdataarkts", "moduleName": "entry" };
            newsModel.isCanRefresh = true;
            newsModel.isRefreshing = true;
            break;
        case 3 /* Success */:
            newsModel.pullDownRefreshText = { "id": 16777240, "type": 10003, params: [], "bundleName": "com.example.newsdataarkts", "moduleName": "entry" };
            newsModel.pullDownRefreshImage = { "id": 16777218, "type": 20000, params: [], "bundleName": "com.example.newsdataarkts", "moduleName": "entry" };
            newsModel.isCanRefresh = true;
            newsModel.isRefreshing = true;
            break;
        case 4 /* Fail */:
            newsModel.pullDownRefreshText = { "id": 16777239, "type": 10003, params: [], "bundleName": "com.example.newsdataarkts", "moduleName": "entry" };
            newsModel.pullDownRefreshImage = { "id": 16777252, "type": 20000, params: [], "bundleName": "com.example.newsdataarkts", "moduleName": "entry" };
            newsModel.isCanRefresh = true;
            newsModel.isRefreshing = true;
            break;
        default:
